---
id: 522cccce-441c-42f3-bc6e-da71b8580280
origin: 14f32bdb-abdd-4a45-9167-a3a7ae5757ac
title: Interview
elements:
  -
    id: mn5utx5t
    ...
    content:
      -
        id: mn5vfra1
        question: 'Vous êtes considéré comme l’une des figures les plus marquantes de l’histoire de l’ASG. Pourriez-vous revenir sur votre parcours et sur les étapes clés qui vous ont mené à la présidence de l’Association ?'
        editor_content:
          -
            type: paragraph
            attrs:
      ...
      -
        id: mn5vfra3
        quote: 'Oft als Belastung wahrgenommen, bietet die Regulierung auch neue Chancen. Sie bietet Vermögensverwaltern insbesondere im zivilrechtlichen Verhältnis Garantien und Schutz.'
        type: quote
        enabled: true
      -
        id: mn5vfra4
        question: 'Quelles étaient les missions principales et les activités centrales de l’Association au début de votre présidence ?'
        editor_content:
          -
            type: paragraph
            attrs:
          ...
          -
            ...
            content:
              -
                type: text
                text: 'En 1997, la gestion de fortune indépendante souffrait encore d’un manque d’harmonisation des pratiques et d’un déficit de reconnaissance institutionnelle. En 1998, la LBA est entrée en vigueur. Ce fut un tournant majeur.'
          -
            type: paragraph
            attrs:
              class: null
        ...
        editor_content:
          ...
          -
            ...
            content:
              -
                type: text
                text: 'Cette période a exigé une forte capacitée d’adaptation stratégique. Durant toutes ces années, le Code de conduite a servi de pierre angulaire à la profession.'
        type: question_answer
        enabled: true
      -
        id: mn5vfra7
        question: 'Au moment de quitter la présidence quels étaient les nouveaux défis ?'
        editor_content:
          -
            type: paragraph
            attrs:
        ...
        editor_content:
          ...
          -
            ...
            content:
              -
                type: text
                text: 'On pourrait penser que la LBA a eu l’impact le plus fort, mais en réalité, les LSFin et LEFin ont transformé le métier de manière beaucoup plus profonde. C’est un changement de paradigme, qui redéfinit ce qu’est la profession de gestionnaire de fortune.'
          -
            type: paragraph
            attrs:
              class: null
            content:
              -
                type: text
                text: 'Avec l’entrée en vigueur des LSFin / LEFin en 2020, le paysage réglementaire suisse a été profondément réorganisé. Pour les gestionnaires de fortune, le Code de conduite a été abrogé puisque les règles de comportement, autrefois définies par l’ASG, ont été intégrées dans la loi.'
        type: question_answer
        enabled: true
      -
        id: mn5vfra9
        question: 'Quels défis vous semblent encore d’actualité ?'
        editor_content:
          -
            type: paragraph
            attrs:
            ...
            content:
              -
                type: text
                text: 'Vingt à trente ans après les premiers défis rencontrés par les gestionnaires de fortune, plusieurs enjeux demeurent pleinement d’actualité. Les évolutions récentes du secteur réglementaires, qu’elles soient technologiques, économiques et sociétales ont transformé ces défis en problématiques plus complexes.'
          -
            type: paragraph
            attrs:
              class: null
        ...
        editor_content:
          ...
          -
            ...
            content:
              -
                type: text
                text: 'Dans un environnement toujours plus réglementé et technologique, il est essentiel de ne jamais perdre de vue ce qui fait la force de notre profession : la relation humaine, la compréhension fine des besoins du client, la capacité à accompagner des familles et des entrepreneurs sur le long terme.'
          -
            type: paragraph
            attrs:
              class: null
            content:
              -
                type: text
                text: 'Les exigences ne cessent d’évoluer, et c’est une bonne chose. La qualité, la compétence et la transparence sont les fondations de notre crédibilité.'
          -
            type: paragraph
            attrs:
              class: null
